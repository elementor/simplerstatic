...
/**
 * Simpler Static SQL Privilege Checker
 *
 * Checks to ensure that the MySQL has permissions needed for Simpler Static.
 */
        ...
        if ( null === self::$instance ) {
            ...
            foreach ( $rows as $row ) {
                ...
                if ( substr( $db_name, -3 ) == '%.*' ) {
                    ...
                    $db_name_match = in_array( $db_name, [ '*.*', $wpdb->dbname . '.*' ] );
                }
